...
require (
	github.com/easyp-tech/easyp v0.16.4
	github.com/easyp-tech/protoc-gen-easydoc v0.4.0
	github.com/easyp-tech/protoc-gen-mcp v0.4.0
...
require (
	...
	github.com/yakwilikk/go-yamlvalidator v0.0.0-20260216223344-568790865548 // indirect
